...
var canonicalize_headers = function(request) {
	...
	_.each(_headers_to_sign, function(header, index) {
...
module.exports = {
	generate_auth: function(request, client_token, client_secret, access_token, headers_to_sign, max_body, guid, timestamp) {
		
		_max_body = max_body || 2048;
		_headers_to_sign = headers_to_sign || [];
		 
		var guid = guid || uuid.v4();
		var timestamp = timestamp || createTimestamp();
